...
Lwl=90*(0.8+np.random.rand(ship_num,1)*(1-0.8) )
Bd=15.6/2*(0.6+np.random.rand(ship_num,1)*(1-0.6) )
Dd=5.6*(0.6+np.random.rand(ship_num,1 )*(1-0.6) )
...
for i in range(ship_num):
    ...
    shipDis=myshipdecoder.Pix2hull(mypts, Lwl[i], Dd[i], Bd[i], 40, 40, 40 - wfb[0], Geometry_path,"SampleHullD"+str(i)+".stl",PC_path,"SampleHullD"+str(i)+".csv")
