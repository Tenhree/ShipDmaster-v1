...
set_seed(42)
def truncated_normal_neg(size, mean=0.0, std=1.0, trunc_max=-1.0, device='cpu', dtype=torch.float):
...
ship_num=6
z = truncated_normal_neg(size=(ship_num, opt.latent_dim), mean=0.0, std=1.0, trunc_max=-1.0, device=device, dtype=torch.float)
...
#build model
Geometry_path=".//Geometry_notBulbbow-inf~-1//"
if not os.path.exists(Geometry_path):
    os.mkdir(Geometry_path)
PC_path = ".//PC_notBulbbow-inf~-1//"
...
# to file
result_path=".//result20D_notBulbbow-inf~-1//"
