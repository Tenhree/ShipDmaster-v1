...
tainingmodel = torch.load("ShipinfoGAN40D.pth", map_location=device)
...
for i in range(ship_num):
    ...
    max_rete=CommonMethod.show_WL_curvaturerate(mypts,".//WLcurvaturerate40D//",i)
