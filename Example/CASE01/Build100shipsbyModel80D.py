...
tainingmodel = torch.load("ShipinfoGAN80D.pth", map_location=device)
...
for i in range(ship_num):
    ...
    max_rete=CommonMethod.show_WL_curvaturerate(mypts,".//WLcurvaturerate80D//",i)
