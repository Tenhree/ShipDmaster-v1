...
tainingmodel = torch.load("ShipinfoGAN60D.pth", map_location=device)
...
for i in range(ship_num):
    ...
    max_rete=CommonMethod.show_WL_curvaturerate(mypts,".//WLcurvaturerate60D//",i)
